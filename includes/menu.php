        ...
        <div class="container-fluid">
            <div class="container px-4 w-75">
                <div class="navbar-brand">
                    <a href="./index.php"><img class="img-fluid" src="./assets/img/Sawari.PNG" style="width: 11%;"
                            href="./index.php" alt="Sawari"></a>
            ...
            <div class="container w-75" style="font-family:'Lora', serif; font-size:17px; margin-left: 150px;">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-3 mb-lg-0 ms-lg-4 ">
                        <li class="nav-item">
                            <a class="nav-link active text-dark px-4" aria-current="page" href="./index.php"><b
                                    class="hov">Home</b></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <?php if (isset($_SESSION['username'])) { ?>
                                <div class="dropdown show">
                                    <a class="nav-link text-dark px-4 dropdown-toggle" href="#" role="button"
