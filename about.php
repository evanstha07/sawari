    ...
    <div class="container py-5">
      <div class="row h-100 align-items-center py-5">
        <div class="col-lg-6">
          ...
          <p class="lead text-muted mb-0">We are a cutting-edge technology platform that aims to make the car rental process simple, efficient, and enjoyable for our customers. Our mission is to provide you with the freedom to explore and travel conveniently by offering a seamless reservation experience.

          </p>
        </div>
        <div class="col-lg-6 d-none d-lg-block">
          <!-- <img src="https://bootstrapious.com/i/snippets/sn-about/illus.png" alt="" class="img-fluid"> -->
          <img src="./assets//img//aboutfirstimg.jpg" alt="Image Description" class="custom-image" style="width:100%; height:100%; border-radius:50% ">
    ...
    <div class="container py-5">
      <div class="row mb-4">
        <div class="col-lg-5">
          ...
          <p class="font text-muted">Driving Efficiency and Growth with Cutting-Edge IT Solutions.</p>
        </div>
      </div>
